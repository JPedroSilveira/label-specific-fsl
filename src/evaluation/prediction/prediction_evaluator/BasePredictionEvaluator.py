...
class BasePredictionEvaluator():
    ...
    '''
    def __init__(self, selector: BaseSelector, selection_size: int, predictor_type: Type[BasePredictor]):
    ...
    def calculate(self, selector: BaseSelector, splitted_dataset: SplittedDataset) -> list[PredictorPredictionScore]:
        '''
